# Generated by Django 5.0.4 on 2024-11-18 15:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_url', models.CharField(blank=True, default='http://127.0.0.1:8001', max_length=255, null=True)),
                ('endpoint', models.CharField(blank=True, max_length=255, null=True)),
                ('methods', models.JSONField(blank=True, null=True)),
                ('version', models.CharField(blank=True, default='v1', max_length=10, null=True)),
                ('params', models.JSONField(blank=True, null=True)),
                ('service_url', models.CharField(blank=True, max_length=500, null=True)),
                ('service_name', models.CharField(max_length=100, unique=True)),
                ('api_root_url', models.CharField(max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_name', models.CharField(choices=[('farm_calendar', 'Farm Calendar'), ('gatekeeper', 'Gatekeeper'), ('weather_data', 'Weather Data'), ('unknown', 'Unknown')], default='unknown', max_length=50)),
