# aegis/views/api/farm_calendar.py
...
class FarmCalendarView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        # Forward request to weather data service via Gatekeeper
        ...
        logger.info(f"Wea   ther Data service response: {weather_response.json()}")
